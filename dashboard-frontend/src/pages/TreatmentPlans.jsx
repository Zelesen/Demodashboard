  ...
  return (
    <div className="bg-[#f7f9fd] font-sans antialiased">
      ...
      <div className="max-w-7xl mx-auto p-3 sm:p-4 lg:p-5 space-y-3 relative z-10">
        ...
        {/* ================= FILTERS ================= */}
        <div className="overflow-x-auto max-w-full lg:self-start flex items-center gap-1 bg-white border border-slate-200/60 rounded-lg p-0.5 shadow-sm sticky top-16 z-30">
          {filters.map((filter) => {
          ...
          {activeFilter === "Custom" && (
            <div className="flex-wrap sm:flex-nowrap items-center gap-2 bg-transparent rounded-lg p-2 flex">
              <div className="flex items-center gap-2">
