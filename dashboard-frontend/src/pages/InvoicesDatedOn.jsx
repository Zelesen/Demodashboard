          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <h1 className="text-[1.3rem] font-bold tracking-tight text-heading leading-tight">Invoices (Dated On)</h1>
              </div>
              ...
              {[
                ...
                <div className="flex items-center gap-1.5 mb-2">
                      ...
                      <div className="flex items-center gap-1 min-w-0">
                        <span className="flex items-center justify-center w-3.5 h-3.5 rounded-full bg-surface-alt text-[7px] font-bold text-muted mr-1 shrink-0 self-center">{index + 22}</span>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-bold text-xs text-heading flex items-center gap-1.5">
                    <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-surface-alt text-[8px] font-bold text-muted">28</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            {invoiceData && (
              <div className="bg-card rounded-2xl border border-card-border/60 shadow-sm overflow-hidden">
                <div className="px-5 py-3 border-b border-card-border">
                  <h3 className="font-bold text-xs text-heading flex items-center gap-1.5">
                    <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-surface-alt text-[8px] font-bold text-muted">29</span>
            ...
            <div className="bg-card rounded-2xl border border-card-border/60 shadow-sm overflow-hidden">
              <div className="px-5 py-3 border-b border-card-border">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-xs text-heading flex items-center gap-1.5">
                      <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-surface-alt text-[8px] font-bold text-muted">30</span>
              ...
              <div className="bg-card rounded-2xl border border-card-border/60 shadow-sm overflow-hidden">
                <div className="px-5 py-3 border-b border-card-border">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-bold text-xs text-heading flex items-center gap-1.5">
                        <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-surface-alt text-[8px] font-bold text-muted">31</span>
              ...
              <div className="bg-card rounded-2xl border border-card-border/60 shadow-sm overflow-hidden">
                <div className="px-5 py-3 border-b border-card-border">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-bold text-xs text-heading flex items-center gap-1.5">
                        <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-surface-alt text-[8px] font-bold text-muted">32</span>
